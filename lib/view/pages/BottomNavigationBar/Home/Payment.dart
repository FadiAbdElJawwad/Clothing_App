    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          SizedBox(height: 30,),
          Padding(padding: EdgeInsets.symmetric(horizontal: 71),
          child: Button(text: 'Get your receipt',
            onTap: () {},),
          ),
          SizedBox(height: 15,),
          Padding(padding: EdgeInsets.symmetric(horizontal: 71),
          child: ElevatedButton(
            ...
            child:
            Text('Back to Home', style: const TextStyle(fontSize: 16, color: ColorManager.MainColor)),
          )
          )
        ],
      ),
